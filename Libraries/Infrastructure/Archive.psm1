...
# Compression streams and archive readers share ownership and output-bound semantics.
...
# SPDX-License-Identifier: MIT
# Shared verbatim with Modules\InstallerParsers\Libraries\Infrastructure\Archive.psm1.
