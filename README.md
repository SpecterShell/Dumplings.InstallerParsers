...
& pwsh -NoProfile -File .\Cli.ps1 `
  ...
  -Name '*.msi' `
  -ExternalDataPath C:\Installers\setup1.bin,C:\Installers\setup2.bin `
...
| `NSIS.Expand` | Expand selected embedded or NSISBI external `EW_EXTRACTFILE` payload records from solid, non-solid, or MTW archives. | `Path`, optional `DestinationPath`, `Name`, `CollisionAction`, `ExternalDataPath`, `MaximumExpandedBytes` |
